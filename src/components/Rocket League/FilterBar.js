  ...
  return (
    <div className="choose-itemsSearchFiltersRL">
      <div className="initial-filter-header-addTrade">
        <div className="magnGlass-container"><img style={{ width: "11px", height: "11px", marginLeft: "2px" }} src={MagnifyingGlass} alt="" /></div>
        <input placeholder="Search items..." onChange={(e) => {
          if (e.target.value !== filters.name) dispatch({
            type: "setFilter",
            payload: {
              type: "name",
        ...
        }} />
        {
          width >= 1778 ?
            ...
            <div className="rl-filters-small-width">
              <div className="sigh" style={filters.tyoe === "Filter" ? { filter: "brightness(1)" } : null} onClick={() => setOpenFilters(!openFilters)}>
