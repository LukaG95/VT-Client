...
function RLitem_icon_dropdown({item}) { 
  ...
  useEffect(()=> {
    ...
    <div 
      ...
      style={height <=650 ? {position: "fixed", top: "280px", right: "510px", marginTop: "-200px", marginLeft: "200px"} : height <= 820 ? {position: "fixed", top: "400px", right: "510px", marginTop: "-200px", marginLeft: "200px"} : null}
    >
      ...
      <button id="delete-rl-filters-button" onClick={()=> deleteRLitem(id)}>Delete</button>
