  ...
  return (
    <>
      ...
      <div className="tos-header" ref={ref}>
        <h1>Trading</h1>
        <p>Last revisioned: 30.04.2021</p>
      </div>
      ...
      <div className="ToS-body">
        ...
        <p>
          ...
          Read below for our full trading rules. 
        </p>
        ...
        <ul>
          ...
          <li>You can only trade for what is presented in the add trade page. Trading for anything else is forbidden</li>
          <li>Scamming and sharking is forbidden and will result in an instant ban (do not -rep scammers, please report them <a href="https://forms.gle/6tqsDSbeMz1q7NpY6" target="_blank" rel="noopener noreferrer">here</a>)</li>
