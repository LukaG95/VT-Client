...
function viewSidebar() {
  ...
  try{                                         // try catch because of error when we use page back, elements (starting with main) aren't defined
    width >= 650 ? main.style.transform = "translateX(400px)" : main.style.transform = `translateX(${sidebar.getBoundingClientRect().width}px)`
